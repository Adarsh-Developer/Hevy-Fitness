        ...
        <div className='flex flex-col gap-4 font-FontTwo pt-10 dark:text-white'>
            ...
            <div className='flex flex-col gap-4 borderWithBackground dark:bg-[#1F2022] dark:border-[#2d2f32] p-4 rounded-[8px]'>
                <div className='flex text-[14px] items-center'>
                    <img src={profilePhoto} alt="" className='min-w-[48px] max-w-[48px] min-h-[48px] max-h-[48px] rounded-[50%] object-cover object-top' />
                    ...
                    <div className='flex flex-col gap-4'>
                        ...
                        <div className='flex flex-col gap-3'>
                            <div className='flex gap-4 items-center'>
                                <img src={profilePhoto} alt="" className='min-w-[48px] min-h-[48px] max-w-[48px] max-h-[48px] rounded-[50%] object-cover object-top' />
                ...
                <div className='flex gap-4'>
                    ...
                    <div className='flex flex-grow gap-4 items-center'>
                        <textarea name="" id="" cols="30" rows="10" placeholder='Write a comment...' className='w-[100%] font-normal h-[50px] resize-none bg-[#f3f4f6] dark:bg-[#191A1C] rounded-[5px] p-3 border-none outline-none overflow-hidden whitespace-nowrap'></textarea>
